 ...
 * $conf['search_template_box_course_providers'] = ''; * from being logged in
 * the Drupal system log. In order to prevent valid pages such as image styles
 * and other generated content that may match the
 * '404_fast_html' regular expression from returning 404 errors, it is
 * necessary
...
if (isset($_ENV['PLATFORM_BRANCH'])) {
  ...
  if ($_ENV['PLATFORM_BRANCH'] == 'master') {
    $base_url = 'https://www.ulf-erhvervsplaymaker.dk';
    $conf['search_api_search_node_host'] = 'https://search-node.ulfiaarhus.dk';
  //  $conf['search_api_search_node_host'] = 'https://search-node.ulf-erhvervsplaymaker.dk';
  ...
  if ($_ENV['PLATFORM_BRANCH'] == 'develop') {
    $conf['search_api_search_node_host'] = 'https://search-node.ulf-erhvervsplaymaker.dk.develop-sr3snxi-ti4ifpbxl6ymg.eu-2.platformsh.site';
...
$conf['ulf_entityform_enable_editor_forms'] = true;

// Search templates
# $conf['search_template_box_courses_dagtilbud'] = 'sites/ulf-erhvervsplaymaker.dk/themes/ulf_hjoerring/templates/search/angular/search-daycare.html';
# $conf['search_template_box_courses_grundskole'] = 'sites/ulf-erhvervsplaymaker.dk/themes/ulf_hjoerring/templates/search/angular/search-school.html';
# $conf['search_template_box_courses_ungdomsuddannelse'] = 'sites/ulf-erhvervsplaymaker.dk/themes/ulf_hjoerring/templates/search/angular/search-youth.html';
# $conf['search_template_box_users'] = '';
...
$dir = dirname(__DIR__);
if (file_exists($dir . '/all/settings.platformsh.php')) {
  $platformsh_subsite_id = 'ulf_erhvervsplaymaker';
  require_once($dir . '/all/settings.platformsh.php');
}

$ddev_settings = 'sites/default/settings.ddev-mod.php';
if (is_readable($ddev_settings)) {
  $database = 'ulf_erhvervsplaymaker';
